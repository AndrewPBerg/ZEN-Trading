  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "cosmic-gradient-2": "linear-gradient(45deg, hsl(var(--primary)) 0%, hsl(var(--secondary)) 25%, hsl(var(--accent)) 50%, hsl(var(--primary)) 75%, hsl(var(--secondary)) 100%)",
        "aurora": "linear-gradient(45deg, #667eea 0%, #764ba2 25%, #f093fb 50%, #f5576c 75%, #4facfe 100%)",
        "nebula": "radial-gradient(ellipse at center, hsl(var(--primary)) 0%, transparent 70%)",
      ...
      boxShadow: {
        "cosmic": "0 0 20px hsl(var(--primary) / 0.3)",
        "cosmic-lg": "0 0 40px hsl(var(--primary) / 0.4)",
        "cosmic-xl": "0 0 60px hsl(var(--primary) / 0.5)",
