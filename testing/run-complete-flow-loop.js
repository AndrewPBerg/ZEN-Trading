// Loop Test Runner for Complete Flow Test
// Runs complete flow tests multiple times to verify end-to-end stability

const { spawn } = require('child_process');

// Configuration
const TEST_FILE = 'test-complete-flow.js';
const ITERATIONS = 3; // Fewer iterations for complete flow (longer test)
const DELAY_BETWEEN_RUNS = 3000; // 3 seconds delay between runs
...
function printHeader() {
  console.log('\n' + '='.repeat(70));
  console.log('🔄 LOOP TEST RUNNER - Complete Flow with Buy/Sell');
...
function printSummary() {
  ...
  if (stats.failed === 0) {
    console.log('\n🎉 All test iterations passed! End-to-end flow is stable.');
  } else {
